...
```bash
============================================================
📊 POPE 评估结果 (Qwen2-VL + VCD + vLLM v1)
============================================================
准确率 (Accuracy):      0.8840
精确率 (Precision):     0.9500
召回率 (Recall):        0.8107
F1分数 (F1 Score):      0.8748
真阳性/真阴性/假阳性/假阴性: 1216/1436/64/284
============================================================
```

```bash
📊 POPE 评估结果 (Qwen2-VL + NoVCD + vLLM v1)
============================================================
准确率 (Accuracy):      0.8833
精确率 (Precision):     0.9506
召回率 (Recall):        0.8087
F1分数 (F1 Score):      0.8739
真阳性/真阴性/假阳性/假阴性: 1213/1437/63/287
```